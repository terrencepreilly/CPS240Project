...
public class Sword implements Weapon {
	...
	/**
	 * This method creates and returns an arc collider for a simulated sword 
	 * swing
	 * @param c the character class, needed for positioning and creating the 
	 * 	ArcCollider (based on angle - characters direction variable - and 
	 * 	character location)
	 * @return an Arc2D.Float "boxcollider" to perform intersect tests to see 
	 * 	if our sword has "hit" an enemy
	 */
